...
export declare const useManualComboBoxEventHandlers: ({ inputProps, inputRef, popoverRef, state }: ManualComboBoxEventProps, { onOpen, onClose, onNavigate, onSelect }: ManualComboBoxEvents) => {
    ...
    onChange?: import("react").FormEventHandler<HTMLInputElement> | undefined;
