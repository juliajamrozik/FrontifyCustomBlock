...
const SegmentedControl = _ref => {
  ...
  const tabTranslateValue = useSharedValue(0); // useCallBack with an empty array as input, which will call inner lambda only once and memoize the reference for future calls
  ...
  useEffect(() => {
    ...
    tabTranslateValue.value = withSpring(currentIndex * (translateValue * transitionMultiplier), DEFAULT_SPRING_CONFIG); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [currentIndex]);
  ...
  return /*#__PURE__*/React.createElement(Animated.View, {
    ...
    style: [styles.movingSegmentStyle, defaultShadowStyle, tileStyle, StyleSheet.absoluteFill, {
    ...
    }, segment), badgeValues[index] && /*#__PURE__*/React.createElement(View, {
