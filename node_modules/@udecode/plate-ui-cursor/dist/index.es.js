...
import { toDOMRange, getNodeEntries, isText, toDOMNode, useEditorRef, usePlateSelectors } from '@udecode/plate-common';
import { Range, Path } from 'slate';

const getCursorOverlayStyles = props => createStyles({
...
const Cursor = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !disableSelection && selectionRects.map((position, i) => Rect ? /*#__PURE__*/React.createElement(Rect, {
    key: i,
    data: data,
  ...
  })), !disableCaret && caretPosition && (Caret ? /*#__PURE__*/React.createElement(Caret, {
    data: data,
...
const getSelectionRects = (editor, {
  ...
  for (const [textNode, textPath] of textEntries) {
    const domNode = toDOMNode(editor, textNode); // Fix: failed to execute 'selectNode' on 'Range': the given Node has no parent
...
export { Cursor, CursorOverlay, CursorOverlayContent, FROZEN_EMPTY_ARRAY, getCaretPosition, getCursorOverlayState, getCursorOverlayStyles, getSelectionRects, useCursorOverlayPositions, useRefreshOnResize, useRequestReRender };
