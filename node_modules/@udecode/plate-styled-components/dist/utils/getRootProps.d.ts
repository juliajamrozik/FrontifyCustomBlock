...
export declare const getRootProps: <V extends Value = Value>(props: StyledElementProps<V, import("@udecode/plate-common").ElementOf<import("@udecode/plate-common").TEditor<V>>, {}> | StyledLeafProps<V, import("@udecode/plate-common").TextOf<import("@udecode/plate-common").TEditor<V>>, {}> | AnyObject) => {
