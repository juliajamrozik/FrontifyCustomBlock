...
const Combobox = ({
  ...
  const editor = plateCommon.usePlateEditorState();
  const focusedEditorId = (_useEventEditorSelect = plateCommon.useEventEditorSelectors.focus) === null || _useEventEditorSelect === void 0 ? void 0 : _useEventEditorSelect.call(plateCommon.useEventEditorSelectors);
  const combobox = plateCombobox.useComboboxControls();
